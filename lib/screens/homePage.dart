...
//     // Fetch slides, salons, recommended, and cities only if not already fetched
//     if (!isDataFetched) {
//       await getSlides();
//       await getSalons();
...
//       // Set the flag to true so that it doesn't fetch again
//       setState(() {
//         isDataFetched = true;
//       });
//     }
...
//   //   logger.d(options);
//   //   logger.d(updatedOptions);

//   //   if (isDataFitched == false) {
//   //     _fetchAndStoreSalons();
